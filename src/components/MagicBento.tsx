    ...
    <>
      ...
      <div className="card-grid bento-section" ref={gridRef}>
        {cards.map((card, index) => {
          const baseClassName = `magic-bento-card ${textAutoHide ? 'magic-bento-card--text-autohide' : ''} ${enableBorderGlow ? 'magic-bento-card--border-glow' : ''} ${card.disabled ? 'magic-bento-card--disabled' : ''}`;
          ...
          const content = (
            <>
              ...
              <div className="magic-bento-card__content">
                ...
                {card.tags && <div className="magic-bento-card__tags">{card.tags}</div>}
              </div>
            </>
          );

          if (enableStars && !card.disabled) {
            return (
              <ParticleCard
                key={index}
              ...
              >
                <div onClick={card.onClick} style={{ cursor: card.onClick ? 'pointer' : 'default' }}>
                  {content}
                </div>
              </ParticleCard>
            );
          ...
          return (
            <div
              key={index}
              className={baseClassName}
              style={{ ...cardStyle, cursor: card.onClick && !card.disabled ? 'pointer' : 'default' }}
